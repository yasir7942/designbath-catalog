...
export async function generateMetadata({ params }) {
  ...
  const metadataParams = {
    ...
    pageDescription: productData.data[0]?.details ? productData.data[0]?.details : "",
    image: productData.data[0].image?.formats.thumbnail.url ? productData.data[0].image?.formats.thumbnail.url : "",
  };
