...
const Home = async () => {
  ...
  return (
    <>
      <h1 className="capitalize text-center font-medium text-xl text-gray-600">
        Product Brands or Category
      </h1>
      <p className="capitalize text-center font-normal text-base text-gray-600">
        Price List
      </p>

      <div className="grid grid-cols-2 items-stretch pb-12 md:pb-26 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 md:gap-2 md:mx-10 xl:gap-x-2 xl:mx-38 mt-5">
        {brands?.data?.map(
          (brand) =>
