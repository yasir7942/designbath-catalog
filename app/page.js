 ...
 */
  return (
    ...
    <>
      ...
      <div className="grid grid-cols-3 items-center pb-10 md:pb-26 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6  gap-2  md:gap-2 md:mx-10 xl:gap-x-2 xl:mx-38  mt-5  ">
        ...
        <div className="text-center">Product Filters</div>
